    ...
    writeToShell(event) {
        ...
        if (shellClient) {
            shellClient.writeToShell(event.nativeEvent.text + '\n', (error) => {
                if (error) {
                    this.setState({shellOutput: shellOutput + error});
                }
            });
        }
            ...
            <ScrollView
                ...
                <View style={{flexDirection: 'row'}}>
                    <View style={{flex: 2, marginRight: 10}}>
                        <TextField labelHeight={15} label="Host" value={host} onChangeText={(host) => this.setState({host})} />
                    </View>
                    <View style={{flex: 1}}>
                        <TextField labelHeight={15} label="Port" value={port} onChangeText={(port) => this.setState({port})} />
                    </View>
                </View>
                <View style={{flexDirection: 'row'}}>
                    <View style={{flex: 1, marginRight: 10}}>
                        <TextField labelHeight={15} label="Username" value={username} onChangeText={(username) => this.setState({username})} />
                    </View>
                    <View style={{flex: 1}}>
                        <TextField labelHeight={15} label="Password" value={password} onChangeText={(password) => this.setState({password})} />
                    </View>
                </View>
                <TextField
                    labelHeight={15}
