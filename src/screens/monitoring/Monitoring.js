...
const Monitoring = ({route, navigation}) => {
    ...
    const dealerdata = data.device.monitoring && device.monitoring.dealer ? device.monitoring.dealer : '';
    ...
    return (
        <View style={styles.appContainer}>
            ...
            <View
                ...
                <View style={{...styles.itemWindow, padding: 0, marginBottom: 20}}>
                    <Text
                        style={{
                            ...styles.h3,
                            fontSize: 14,
